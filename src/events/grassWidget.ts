  ...
  const svgText = `<?xml version="1.0" encoding="utf-8"?>
    ...
    >
      ...
      <g>
        ...
        <text style="font-size:8px; font-weight: bolder; fill:#58595B;" transform="matrix(1 0 0 1 6.1306 12.5321)">${username}</text>
        <text style="font-size:8px; font-weight: bolder; fill:#58595B;" transform="matrix(1 0 0 1 160.1461 12.5321)">TOTAL : ${total}</text>
